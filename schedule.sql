...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Сен 20 2020 г., 12:06
...
--
ALTER TABLE `schedule`
  ADD CONSTRAINT `schedule_ibfk_1` FOREIGN KEY (`lesson_num_id`) REFERENCES `lesson_num` (`lesson_num_id`),
  ADD CONSTRAINT `schedule_ibfk_2` FOREIGN KEY (`lesson_plan_id`) REFERENCES `lesson_plan` (`lesson_plan_id`),
